...
pub struct GetAllowancesArgs {
    pub prev_spender_id: Option<String>,
...
impl Service {
    pub async fn account_balance(&self, arg0: AccountIdentifierByteBuf) -> Result<(Tokens,)> {
    ...
    pub async fn get_allowances(&self, arg0: GetAllowancesArgs) -> Result<(Vec<Allowance>,)> {
        ic_cdk::call(self.0, "get_allowances", (arg0,)).await
    }
    pub async fn icrc_10_supported_standards(&self) -> Result<(Vec<StandardRecord>,)> {
    ...
    pub async fn icrc_2_allowance(&self, arg0: AllowanceArgs) -> Result<(Allowance1,)> {
